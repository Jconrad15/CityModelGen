...
namespace UnityFBXExporter
{
	...
	public class RuntimeExporterMono : MonoBehaviour
	{
		...
		*/
		...
		{
			string FileName = DateTime.Now.ToString("yyyy,MM,dd,HH,mm,ss") + "_" + index.ToString() + "_" + "model.fbx";
			index++;
			return ExportGameObject(rootObjectToExport, FileName, TextureFolderName);
		}
		...
		/// <returns></returns>
		public static bool ExportGameObject(GameObject rootGameObject, string fileName, string textureFolderName)
		{
...
/*			// forces use of forward slash for directory names
            ...
            string folderPath = System.IO.Path.Combine(Environment.GetFolderPath(
				Environment.SpecialFolder.MyDoc‌​uments), "Gogodinosaur");
